...
const favItems = document.getElementsByClassName('fav-list');
...
function displayMovieDetails(details) {
    ...
    document.getElementById('info').innerHTML = `<p class="highlight" id="title" > Title: ${details.Title}     <i  id="heart" class="fas fa-heart"></i> <p>
    <p class="highlightRed"> Year: ${details.Year} <p>
    <p> Released:${details.Released}</p>
    <p> Genre: ${details.Genre}</p>
    <p class="highlight" >Plot: ${details.Plot}</p>
